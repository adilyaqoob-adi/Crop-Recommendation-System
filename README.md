...
**As a Mechatronics Engineer**, I plan to expand this project into a full IoT solution:

Hardware: Integrating ESP32/Arduino with NPK and soil moisture sensors.

Connectivity: Implementing LoRaWAN for data transmission in remote semi-arid regions.

Automation: Using the model output to trigger automated smart irrigation systems.
